...
import { l as buildAssetsURL, m as useRuntimeConfig, n as getResponseStatusText, o as getResponseStatus, p as defineRenderHandler, q as publicAssetsURL, s as getQuery, c as createError, t as destr, v as getRouteRules, x as joinURL, y as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/assets/favicon.ico"}],"style":[],"script":[],"noscript":[]};
